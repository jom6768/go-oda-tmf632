...
// checks if the CharacteristicMVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CharacteristicMVO{}

// CharacteristicMVO struct for CharacteristicMVO
...
type _CharacteristicMVO CharacteristicMVO
...
func (o *CharacteristicMVO) GetCharacteristicRelationship() []CharacteristicRelationshipMVO {
	if o == nil || IsNil(o.CharacteristicRelationship) {
		var ret []CharacteristicRelationshipMVO
		return ret
	}
...
// SetCharacteristicRelationship gets a reference to the given []CharacteristicRelationshipMVO and assigns it to the CharacteristicRelationship field.
func (o *CharacteristicMVO) SetCharacteristicRelationship(v []CharacteristicRelationshipMVO) {
	o.CharacteristicRelationship = v
}

func (o CharacteristicMVO) MarshalJSON() ([]byte, error) {
...
func (o CharacteristicMVO) ToMap() (map[string]interface{}, error) {
...
func (o *CharacteristicMVO) UnmarshalJSON(data []byte) (err error) {
	...
	varCharacteristicMVO := _CharacteristicMVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCharacteristicMVO)

	if err != nil {
		return err
	}

	*o = CharacteristicMVO(varCharacteristicMVO)

	return err
}

type NullableCharacteristicMVO struct {
	value *CharacteristicMVO
	isSet bool
}

func (v NullableCharacteristicMVO) Get() *CharacteristicMVO {
	return v.value
}

func (v *NullableCharacteristicMVO) Set(val *CharacteristicMVO) {
	v.value = val
	v.isSet = true
}

func (v NullableCharacteristicMVO) IsSet() bool {
	return v.isSet
}

func (v *NullableCharacteristicMVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCharacteristicMVO(val *CharacteristicMVO) *NullableCharacteristicMVO {
	return &NullableCharacteristicMVO{value: val, isSet: true}
}

func (v NullableCharacteristicMVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCharacteristicMVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
