...
// checks if the TaxDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxDefinition{}

// TaxDefinition struct for TaxDefinition
...
type _TaxDefinition TaxDefinition
...
func (o TaxDefinition) MarshalJSON() ([]byte, error) {
...
func (o TaxDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *TaxDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	varTaxDefinition := _TaxDefinition{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaxDefinition)

	if err != nil {
		return err
	}

	*o = TaxDefinition(varTaxDefinition)

	return err
}

type NullableTaxDefinition struct {
	value *TaxDefinition
	isSet bool
}

func (v NullableTaxDefinition) Get() *TaxDefinition {
	return v.value
}

func (v *NullableTaxDefinition) Set(val *TaxDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxDefinition(val *TaxDefinition) *NullableTaxDefinition {
	return &NullableTaxDefinition{value: val, isSet: true}
}

func (v NullableTaxDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
