...
// checks if the OrganizationCreateEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationCreateEvent{}

// OrganizationCreateEvent struct for OrganizationCreateEvent
type OrganizationCreateEvent struct {
	...
	Event *OrganizationCreateEventPayload `json:"event,omitempty"`
}

type _OrganizationCreateEvent OrganizationCreateEvent
...
func (o *OrganizationCreateEvent) GetEvent() OrganizationCreateEventPayload {
	if o == nil || IsNil(o.Event) {
		var ret OrganizationCreateEventPayload
		return ret
	}
	return *o.Event
}
...
// SetEvent gets a reference to the given OrganizationCreateEventPayload and assigns it to the Event field.
func (o *OrganizationCreateEvent) SetEvent(v OrganizationCreateEventPayload) {
	o.Event = &v
}

func (o OrganizationCreateEvent) MarshalJSON() ([]byte, error) {
...
func (o OrganizationCreateEvent) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationCreateEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationCreateEvent := _OrganizationCreateEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationCreateEvent)

	if err != nil {
		return err
	}

	*o = OrganizationCreateEvent(varOrganizationCreateEvent)

	return err
}

type NullableOrganizationCreateEvent struct {
	value *OrganizationCreateEvent
	isSet bool
}

func (v NullableOrganizationCreateEvent) Get() *OrganizationCreateEvent {
	return v.value
}

func (v *NullableOrganizationCreateEvent) Set(val *OrganizationCreateEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationCreateEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationCreateEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationCreateEvent(val *OrganizationCreateEvent) *NullableOrganizationCreateEvent {
	return &NullableOrganizationCreateEvent{value: val, isSet: true}
}

func (v NullableOrganizationCreateEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationCreateEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
