...
// checks if the EntityRefFVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityRefFVO{}

// EntityRefFVO struct for EntityRefFVO
...
type _EntityRefFVO EntityRefFVO
...
func (o EntityRefFVO) MarshalJSON() ([]byte, error) {
...
func (o EntityRefFVO) ToMap() (map[string]interface{}, error) {
...
func (o *EntityRefFVO) UnmarshalJSON(data []byte) (err error) {
	...
	varEntityRefFVO := _EntityRefFVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEntityRefFVO)

	if err != nil {
		return err
	}

	*o = EntityRefFVO(varEntityRefFVO)

	return err
}

type NullableEntityRefFVO struct {
	value *EntityRefFVO
	isSet bool
}

func (v NullableEntityRefFVO) Get() *EntityRefFVO {
	return v.value
}

func (v *NullableEntityRefFVO) Set(val *EntityRefFVO) {
	v.value = val
	v.isSet = true
}

func (v NullableEntityRefFVO) IsSet() bool {
	return v.isSet
}

func (v *NullableEntityRefFVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntityRefFVO(val *EntityRefFVO) *NullableEntityRefFVO {
	return &NullableEntityRefFVO{value: val, isSet: true}
}

func (v NullableEntityRefFVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntityRefFVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
