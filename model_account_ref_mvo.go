...
// checks if the AccountRefMVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountRefMVO{}

// AccountRefMVO Account reference. A account may be a party account or a financial account.
type AccountRefMVO struct {
...
type _AccountRefMVO AccountRefMVO
...
func (o AccountRefMVO) MarshalJSON() ([]byte, error) {
...
func (o AccountRefMVO) ToMap() (map[string]interface{}, error) {
...
func (o *AccountRefMVO) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountRefMVO := _AccountRefMVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountRefMVO)

	if err != nil {
		return err
	}

	*o = AccountRefMVO(varAccountRefMVO)

	return err
}

type NullableAccountRefMVO struct {
	value *AccountRefMVO
	isSet bool
}

func (v NullableAccountRefMVO) Get() *AccountRefMVO {
	return v.value
}

func (v *NullableAccountRefMVO) Set(val *AccountRefMVO) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountRefMVO) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountRefMVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountRefMVO(val *AccountRefMVO) *NullableAccountRefMVO {
	return &NullableAccountRefMVO{value: val, isSet: true}
}

func (v NullableAccountRefMVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountRefMVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
