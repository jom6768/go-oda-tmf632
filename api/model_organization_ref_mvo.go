...
// checks if the OrganizationRefMVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationRefMVO{}

// OrganizationRefMVO struct for OrganizationRefMVO
type OrganizationRefMVO struct {
...
type _OrganizationRefMVO OrganizationRefMVO
...
func (o OrganizationRefMVO) MarshalJSON() ([]byte, error) {
...
func (o OrganizationRefMVO) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationRefMVO) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationRefMVO := _OrganizationRefMVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationRefMVO)

	if err != nil {
		return err
	}

	*o = OrganizationRefMVO(varOrganizationRefMVO)

	return err
}

type NullableOrganizationRefMVO struct {
	value *OrganizationRefMVO
	isSet bool
}

func (v NullableOrganizationRefMVO) Get() *OrganizationRefMVO {
	return v.value
}

func (v *NullableOrganizationRefMVO) Set(val *OrganizationRefMVO) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationRefMVO) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationRefMVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationRefMVO(val *OrganizationRefMVO) *NullableOrganizationRefMVO {
	return &NullableOrganizationRefMVO{value: val, isSet: true}
}

func (v NullableOrganizationRefMVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationRefMVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
