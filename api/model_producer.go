...
func (o *Producer) UnmarshalJSON(data []byte) (err error) {
	...
	varProducer := _Producer{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProducer)

	if err != nil {
		return err
	}

	*o = Producer(varProducer)
