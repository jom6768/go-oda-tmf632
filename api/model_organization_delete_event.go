...
// checks if the OrganizationDeleteEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationDeleteEvent{}

// OrganizationDeleteEvent struct for OrganizationDeleteEvent
type OrganizationDeleteEvent struct {
	...
	Event *OrganizationDeleteEventPayload `json:"event,omitempty"`
}

type _OrganizationDeleteEvent OrganizationDeleteEvent
...
func (o *OrganizationDeleteEvent) GetEvent() OrganizationDeleteEventPayload {
	if o == nil || IsNil(o.Event) {
		var ret OrganizationDeleteEventPayload
		return ret
	}
	return *o.Event
}
...
// SetEvent gets a reference to the given OrganizationDeleteEventPayload and assigns it to the Event field.
func (o *OrganizationDeleteEvent) SetEvent(v OrganizationDeleteEventPayload) {
	o.Event = &v
}

func (o OrganizationDeleteEvent) MarshalJSON() ([]byte, error) {
...
func (o OrganizationDeleteEvent) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationDeleteEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationDeleteEvent := _OrganizationDeleteEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationDeleteEvent)

	if err != nil {
		return err
	}

	*o = OrganizationDeleteEvent(varOrganizationDeleteEvent)

	return err
}

type NullableOrganizationDeleteEvent struct {
	value *OrganizationDeleteEvent
	isSet bool
}

func (v NullableOrganizationDeleteEvent) Get() *OrganizationDeleteEvent {
	return v.value
}

func (v *NullableOrganizationDeleteEvent) Set(val *OrganizationDeleteEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationDeleteEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationDeleteEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationDeleteEvent(val *OrganizationDeleteEvent) *NullableOrganizationDeleteEvent {
	return &NullableOrganizationDeleteEvent{value: val, isSet: true}
}

func (v NullableOrganizationDeleteEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationDeleteEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
