...
// checks if the PartyRefFVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartyRefFVO{}

// PartyRefFVO A Party reference
...
func (o PartyRefFVO) MarshalJSON() ([]byte, error) {
...
func (o PartyRefFVO) ToMap() (map[string]interface{}, error) {
...
func (o *PartyRefFVO) UnmarshalJSON(data []byte) (err error) {
	...
	varPartyRefFVO := _PartyRefFVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPartyRefFVO)

	if err != nil {
		return err
	}

	*o = PartyRefFVO(varPartyRefFVO)

	return err
}

type NullablePartyRefFVO struct {
	value *PartyRefFVO
	isSet bool
}

func (v NullablePartyRefFVO) Get() *PartyRefFVO {
	return v.value
}

func (v *NullablePartyRefFVO) Set(val *PartyRefFVO) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyRefFVO) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyRefFVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyRefFVO(val *PartyRefFVO) *NullablePartyRefFVO {
	return &NullablePartyRefFVO{value: val, isSet: true}
}

func (v NullablePartyRefFVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyRefFVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
