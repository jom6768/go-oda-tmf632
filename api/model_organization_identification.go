...
// checks if the OrganizationIdentification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationIdentification{}

// OrganizationIdentification struct for OrganizationIdentification
...
type _OrganizationIdentification OrganizationIdentification
...
func NewOrganizationIdentification(type_ string) *OrganizationIdentification {
	this := OrganizationIdentification{}
	this.Type = type_
	return &this
}
...
func (o OrganizationIdentification) MarshalJSON() ([]byte, error) {
...
func (o OrganizationIdentification) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationIdentification) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationIdentification := _OrganizationIdentification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationIdentification)

	if err != nil {
		return err
	}

	*o = OrganizationIdentification(varOrganizationIdentification)

	return err
}

type NullableOrganizationIdentification struct {
	value *OrganizationIdentification
	isSet bool
}

func (v NullableOrganizationIdentification) Get() *OrganizationIdentification {
	return v.value
}

func (v *NullableOrganizationIdentification) Set(val *OrganizationIdentification) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationIdentification) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationIdentification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationIdentification(val *OrganizationIdentification) *NullableOrganizationIdentification {
	return &NullableOrganizationIdentification{value: val, isSet: true}
}

func (v NullableOrganizationIdentification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationIdentification) UnmarshalJSON(src []byte) error {
	v.isSet = true
