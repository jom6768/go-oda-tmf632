...
// checks if the OrganizationAttributeValueChangeEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationAttributeValueChangeEvent{}

// OrganizationAttributeValueChangeEvent struct for OrganizationAttributeValueChangeEvent
type OrganizationAttributeValueChangeEvent struct {
	...
	Event *OrganizationAttributeValueChangeEventPayload `json:"event,omitempty"`
}

type _OrganizationAttributeValueChangeEvent OrganizationAttributeValueChangeEvent
...
func NewOrganizationAttributeValueChangeEvent(type_ string) *OrganizationAttributeValueChangeEvent {
	this := OrganizationAttributeValueChangeEvent{}
	this.Type = type_
	return &this
}
...
func (o *OrganizationAttributeValueChangeEvent) GetEvent() OrganizationAttributeValueChangeEventPayload {
	if o == nil || IsNil(o.Event) {
		var ret OrganizationAttributeValueChangeEventPayload
		return ret
	}
	return *o.Event
}
...
// SetEvent gets a reference to the given OrganizationAttributeValueChangeEventPayload and assigns it to the Event field.
func (o *OrganizationAttributeValueChangeEvent) SetEvent(v OrganizationAttributeValueChangeEventPayload) {
	o.Event = &v
}

func (o OrganizationAttributeValueChangeEvent) MarshalJSON() ([]byte, error) {
...
func (o OrganizationAttributeValueChangeEvent) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationAttributeValueChangeEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationAttributeValueChangeEvent := _OrganizationAttributeValueChangeEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationAttributeValueChangeEvent)

	if err != nil {
		return err
	}

	*o = OrganizationAttributeValueChangeEvent(varOrganizationAttributeValueChangeEvent)

	return err
}

type NullableOrganizationAttributeValueChangeEvent struct {
	value *OrganizationAttributeValueChangeEvent
	isSet bool
}

func (v NullableOrganizationAttributeValueChangeEvent) Get() *OrganizationAttributeValueChangeEvent {
	return v.value
}

func (v *NullableOrganizationAttributeValueChangeEvent) Set(val *OrganizationAttributeValueChangeEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationAttributeValueChangeEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationAttributeValueChangeEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationAttributeValueChangeEvent(val *OrganizationAttributeValueChangeEvent) *NullableOrganizationAttributeValueChangeEvent {
	return &NullableOrganizationAttributeValueChangeEvent{value: val, isSet: true}
}

func (v NullableOrganizationAttributeValueChangeEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationAttributeValueChangeEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
