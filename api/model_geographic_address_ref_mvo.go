...
// checks if the GeographicAddressRefMVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GeographicAddressRefMVO{}

// GeographicAddressRefMVO Reference to a Geographic Address.
type GeographicAddressRefMVO struct {
...
type _GeographicAddressRefMVO GeographicAddressRefMVO
...
func (o GeographicAddressRefMVO) MarshalJSON() ([]byte, error) {
...
func (o GeographicAddressRefMVO) ToMap() (map[string]interface{}, error) {
...
func (o *GeographicAddressRefMVO) UnmarshalJSON(data []byte) (err error) {
	...
	varGeographicAddressRefMVO := _GeographicAddressRefMVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGeographicAddressRefMVO)

	if err != nil {
		return err
	}

	*o = GeographicAddressRefMVO(varGeographicAddressRefMVO)

	return err
}

type NullableGeographicAddressRefMVO struct {
	value *GeographicAddressRefMVO
	isSet bool
}

func (v NullableGeographicAddressRefMVO) Get() *GeographicAddressRefMVO {
	return v.value
}

func (v *NullableGeographicAddressRefMVO) Set(val *GeographicAddressRefMVO) {
	v.value = val
	v.isSet = true
}

func (v NullableGeographicAddressRefMVO) IsSet() bool {
	return v.isSet
}

func (v *NullableGeographicAddressRefMVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGeographicAddressRefMVO(val *GeographicAddressRefMVO) *NullableGeographicAddressRefMVO {
	return &NullableGeographicAddressRefMVO{value: val, isSet: true}
}

func (v NullableGeographicAddressRefMVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGeographicAddressRefMVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
