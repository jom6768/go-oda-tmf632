...
// checks if the AgreementRefMVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgreementRefMVO{}

// AgreementRefMVO Agreement reference. An agreement represents a contract or arrangement, either written or verbal and sometimes enforceable by law, such as a service level agreement or a customer price agreement. An agreement involves a number of other business entities, such as products, services, and resources and/or their specifications.
...
type _AgreementRefMVO AgreementRefMVO
...
func (o AgreementRefMVO) MarshalJSON() ([]byte, error) {
...
func (o AgreementRefMVO) ToMap() (map[string]interface{}, error) {
...
func (o *AgreementRefMVO) UnmarshalJSON(data []byte) (err error) {
	...
	varAgreementRefMVO := _AgreementRefMVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAgreementRefMVO)

	if err != nil {
		return err
	}

	*o = AgreementRefMVO(varAgreementRefMVO)

	return err
}

type NullableAgreementRefMVO struct {
	value *AgreementRefMVO
	isSet bool
}

func (v NullableAgreementRefMVO) Get() *AgreementRefMVO {
	return v.value
}

func (v *NullableAgreementRefMVO) Set(val *AgreementRefMVO) {
	v.value = val
	v.isSet = true
}

func (v NullableAgreementRefMVO) IsSet() bool {
	return v.isSet
}

func (v *NullableAgreementRefMVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgreementRefMVO(val *AgreementRefMVO) *NullableAgreementRefMVO {
	return &NullableAgreementRefMVO{value: val, isSet: true}
}

func (v NullableAgreementRefMVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgreementRefMVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
