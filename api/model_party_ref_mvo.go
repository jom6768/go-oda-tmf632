...
// checks if the PartyRefMVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartyRefMVO{}

// PartyRefMVO A Party reference
...
func (o PartyRefMVO) MarshalJSON() ([]byte, error) {
...
func (o PartyRefMVO) ToMap() (map[string]interface{}, error) {
...
func (o *PartyRefMVO) UnmarshalJSON(data []byte) (err error) {
	...
	varPartyRefMVO := _PartyRefMVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPartyRefMVO)

	if err != nil {
		return err
	}

	*o = PartyRefMVO(varPartyRefMVO)

	return err
}

type NullablePartyRefMVO struct {
	value *PartyRefMVO
	isSet bool
}

func (v NullablePartyRefMVO) Get() *PartyRefMVO {
	return v.value
}

func (v *NullablePartyRefMVO) Set(val *PartyRefMVO) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyRefMVO) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyRefMVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyRefMVO(val *PartyRefMVO) *NullablePartyRefMVO {
	return &NullablePartyRefMVO{value: val, isSet: true}
}

func (v NullablePartyRefMVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyRefMVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
