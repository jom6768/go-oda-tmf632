...
// checks if the PartyRoleSpecificationRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartyRoleSpecificationRef{}

// PartyRoleSpecificationRef Party role specification reference. A party role specification gives additional details on the part played by a party in a given context.
type PartyRoleSpecificationRef struct {
...
type _PartyRoleSpecificationRef PartyRoleSpecificationRef
...
func NewPartyRoleSpecificationRef(type_ string, id string) *PartyRoleSpecificationRef {
	this := PartyRoleSpecificationRef{}
	this.Type = type_
	this.Id = id
	return &this
}
...
func (o PartyRoleSpecificationRef) MarshalJSON() ([]byte, error) {
...
func (o PartyRoleSpecificationRef) ToMap() (map[string]interface{}, error) {
...
func (o *PartyRoleSpecificationRef) UnmarshalJSON(data []byte) (err error) {
	...
	varPartyRoleSpecificationRef := _PartyRoleSpecificationRef{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPartyRoleSpecificationRef)

	if err != nil {
		return err
	}

	*o = PartyRoleSpecificationRef(varPartyRoleSpecificationRef)

	return err
}

type NullablePartyRoleSpecificationRef struct {
	value *PartyRoleSpecificationRef
	isSet bool
}

func (v NullablePartyRoleSpecificationRef) Get() *PartyRoleSpecificationRef {
	return v.value
}

func (v *NullablePartyRoleSpecificationRef) Set(val *PartyRoleSpecificationRef) {
	v.value = val
	v.isSet = true
}

func (v NullablePartyRoleSpecificationRef) IsSet() bool {
	return v.isSet
}

func (v *NullablePartyRoleSpecificationRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartyRoleSpecificationRef(val *PartyRoleSpecificationRef) *NullablePartyRoleSpecificationRef {
	return &NullablePartyRoleSpecificationRef{value: val, isSet: true}
}

func (v NullablePartyRoleSpecificationRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartyRoleSpecificationRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
