...
// checks if the RelatedPartyRefOrPartyRoleRefFVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelatedPartyRefOrPartyRoleRefFVO{}

// RelatedPartyRefOrPartyRoleRefFVO struct for RelatedPartyRefOrPartyRoleRefFVO
...
type _RelatedPartyRefOrPartyRoleRefFVO RelatedPartyRefOrPartyRoleRefFVO
...
func NewRelatedPartyRefOrPartyRoleRefFVO(type_ string, role string) *RelatedPartyRefOrPartyRoleRefFVO {
	this := RelatedPartyRefOrPartyRoleRefFVO{}
	this.Type = type_
	this.Role = role
	return &this
}
...
func (o RelatedPartyRefOrPartyRoleRefFVO) MarshalJSON() ([]byte, error) {
...
func (o RelatedPartyRefOrPartyRoleRefFVO) ToMap() (map[string]interface{}, error) {
...
func (o *RelatedPartyRefOrPartyRoleRefFVO) UnmarshalJSON(data []byte) (err error) {
	...
	varRelatedPartyRefOrPartyRoleRefFVO := _RelatedPartyRefOrPartyRoleRefFVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRelatedPartyRefOrPartyRoleRefFVO)

	if err != nil {
		return err
	}

	*o = RelatedPartyRefOrPartyRoleRefFVO(varRelatedPartyRefOrPartyRoleRefFVO)

	return err
}

type NullableRelatedPartyRefOrPartyRoleRefFVO struct {
	value *RelatedPartyRefOrPartyRoleRefFVO
	isSet bool
}

func (v NullableRelatedPartyRefOrPartyRoleRefFVO) Get() *RelatedPartyRefOrPartyRoleRefFVO {
	return v.value
}

func (v *NullableRelatedPartyRefOrPartyRoleRefFVO) Set(val *RelatedPartyRefOrPartyRoleRefFVO) {
	v.value = val
	v.isSet = true
}

func (v NullableRelatedPartyRefOrPartyRoleRefFVO) IsSet() bool {
	return v.isSet
}

func (v *NullableRelatedPartyRefOrPartyRoleRefFVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelatedPartyRefOrPartyRoleRefFVO(val *RelatedPartyRefOrPartyRoleRefFVO) *NullableRelatedPartyRefOrPartyRoleRefFVO {
	return &NullableRelatedPartyRefOrPartyRoleRefFVO{value: val, isSet: true}
}

func (v NullableRelatedPartyRefOrPartyRoleRefFVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelatedPartyRefOrPartyRoleRefFVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
