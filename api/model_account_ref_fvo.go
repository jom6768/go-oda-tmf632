...
// checks if the AccountRefFVO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountRefFVO{}

// AccountRefFVO Account reference. A account may be a party account or a financial account.
type AccountRefFVO struct {
...
type _AccountRefFVO AccountRefFVO
...
func (o AccountRefFVO) MarshalJSON() ([]byte, error) {
...
func (o AccountRefFVO) ToMap() (map[string]interface{}, error) {
...
func (o *AccountRefFVO) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountRefFVO := _AccountRefFVO{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountRefFVO)

	if err != nil {
		return err
	}

	*o = AccountRefFVO(varAccountRefFVO)

	return err
}

type NullableAccountRefFVO struct {
	value *AccountRefFVO
	isSet bool
}

func (v NullableAccountRefFVO) Get() *AccountRefFVO {
	return v.value
}

func (v *NullableAccountRefFVO) Set(val *AccountRefFVO) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountRefFVO) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountRefFVO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountRefFVO(val *AccountRefFVO) *NullableAccountRefFVO {
	return &NullableAccountRefFVO{value: val, isSet: true}
}

func (v NullableAccountRefFVO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountRefFVO) UnmarshalJSON(src []byte) error {
	v.isSet = true
