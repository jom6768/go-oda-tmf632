...
`func (o *AttachmentRefOrValueMVO) SetType(v string)`
...
`func (o *AttachmentRefOrValueMVO) GetHref() string`
...
`func (o *AttachmentRefOrValueMVO) SetName(v string)`
