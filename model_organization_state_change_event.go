...
// checks if the OrganizationStateChangeEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationStateChangeEvent{}

// OrganizationStateChangeEvent struct for OrganizationStateChangeEvent
type OrganizationStateChangeEvent struct {
	...
	Event *OrganizationStateChangeEventPayload `json:"event,omitempty"`
}

type _OrganizationStateChangeEvent OrganizationStateChangeEvent
...
func NewOrganizationStateChangeEvent(type_ string) *OrganizationStateChangeEvent {
	this := OrganizationStateChangeEvent{}
	this.Type = type_
	return &this
}
...
func (o *OrganizationStateChangeEvent) GetEvent() OrganizationStateChangeEventPayload {
	if o == nil || IsNil(o.Event) {
		var ret OrganizationStateChangeEventPayload
		return ret
	}
	return *o.Event
}
...
// SetEvent gets a reference to the given OrganizationStateChangeEventPayload and assigns it to the Event field.
func (o *OrganizationStateChangeEvent) SetEvent(v OrganizationStateChangeEventPayload) {
	o.Event = &v
}

func (o OrganizationStateChangeEvent) MarshalJSON() ([]byte, error) {
...
func (o OrganizationStateChangeEvent) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationStateChangeEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationStateChangeEvent := _OrganizationStateChangeEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationStateChangeEvent)

	if err != nil {
		return err
	}

	*o = OrganizationStateChangeEvent(varOrganizationStateChangeEvent)

	return err
}

type NullableOrganizationStateChangeEvent struct {
	value *OrganizationStateChangeEvent
	isSet bool
}

func (v NullableOrganizationStateChangeEvent) Get() *OrganizationStateChangeEvent {
	return v.value
}

func (v *NullableOrganizationStateChangeEvent) Set(val *OrganizationStateChangeEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationStateChangeEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationStateChangeEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationStateChangeEvent(val *OrganizationStateChangeEvent) *NullableOrganizationStateChangeEvent {
	return &NullableOrganizationStateChangeEvent{value: val, isSet: true}
}

func (v NullableOrganizationStateChangeEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationStateChangeEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
