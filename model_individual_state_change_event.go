...
// checks if the IndividualStateChangeEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IndividualStateChangeEvent{}

// IndividualStateChangeEvent struct for IndividualStateChangeEvent
type IndividualStateChangeEvent struct {
	...
	Event *IndividualStateChangeEventPayload `json:"event,omitempty"`
}

type _IndividualStateChangeEvent IndividualStateChangeEvent
...
func NewIndividualStateChangeEvent(type_ string) *IndividualStateChangeEvent {
	this := IndividualStateChangeEvent{}
	this.Type = type_
	return &this
}
...
func (o *IndividualStateChangeEvent) GetEvent() IndividualStateChangeEventPayload {
	if o == nil || IsNil(o.Event) {
		var ret IndividualStateChangeEventPayload
		return ret
	}
	return *o.Event
}
...
// SetEvent gets a reference to the given IndividualStateChangeEventPayload and assigns it to the Event field.
func (o *IndividualStateChangeEvent) SetEvent(v IndividualStateChangeEventPayload) {
	o.Event = &v
}

func (o IndividualStateChangeEvent) MarshalJSON() ([]byte, error) {
...
func (o IndividualStateChangeEvent) ToMap() (map[string]interface{}, error) {
...
func (o *IndividualStateChangeEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varIndividualStateChangeEvent := _IndividualStateChangeEvent{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varIndividualStateChangeEvent)

	if err != nil {
		return err
	}

	*o = IndividualStateChangeEvent(varIndividualStateChangeEvent)

	return err
}

type NullableIndividualStateChangeEvent struct {
	value *IndividualStateChangeEvent
	isSet bool
}

func (v NullableIndividualStateChangeEvent) Get() *IndividualStateChangeEvent {
	return v.value
}

func (v *NullableIndividualStateChangeEvent) Set(val *IndividualStateChangeEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableIndividualStateChangeEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableIndividualStateChangeEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndividualStateChangeEvent(val *IndividualStateChangeEvent) *NullableIndividualStateChangeEvent {
	return &NullableIndividualStateChangeEvent{value: val, isSet: true}
}

func (v NullableIndividualStateChangeEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndividualStateChangeEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
