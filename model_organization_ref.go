...
// checks if the OrganizationRef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganizationRef{}

// OrganizationRef struct for OrganizationRef
...
type _OrganizationRef OrganizationRef
...
func (o OrganizationRef) MarshalJSON() ([]byte, error) {
...
func (o OrganizationRef) ToMap() (map[string]interface{}, error) {
...
func (o *OrganizationRef) UnmarshalJSON(data []byte) (err error) {
	...
	varOrganizationRef := _OrganizationRef{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOrganizationRef)

	if err != nil {
		return err
	}

	*o = OrganizationRef(varOrganizationRef)

	return err
}

type NullableOrganizationRef struct {
	value *OrganizationRef
	isSet bool
}

func (v NullableOrganizationRef) Get() *OrganizationRef {
	return v.value
}

func (v *NullableOrganizationRef) Set(val *OrganizationRef) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationRef) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationRef) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationRef(val *OrganizationRef) *NullableOrganizationRef {
	return &NullableOrganizationRef{value: val, isSet: true}
}

func (v NullableOrganizationRef) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationRef) UnmarshalJSON(src []byte) error {
	v.isSet = true
